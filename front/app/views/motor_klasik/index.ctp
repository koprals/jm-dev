...
<?php echo $this->requestAction("/Template/DaftarKota/{$current_category_id}/{$current_city}/MotorKlasik",array("return"))?>
...
function GotoPage(value)
{
	...
	location.href	=	'<?php echo $settings['site_url']."MotorKlasik/".implode("/",$this->params['pass'])?>/page:'+val;
}
