	...
	function Main()
	{
		...
		foreach($data as $data)
		{
			...
			<AD>
				...
				<DESCRIPTION><![CDATA['.$data['Product']["description"].'<br><br>Lihat detailnya disini : <a href="'.$settings['site_url'].'Iklan/Detail/'.$data["Product"]["id"]."/".$this->seoUrl("motor dijual ".$data["Parent"]["name"]." ".$data["Category"]["name"]." (".$data["Product"]["thn_pembuatan"].") ".$data["ProvinceGroup"]["name"]).'.html">'.$settings['site_url'].'Iklan/Detail/'.$data["Product"]["id"]."/".$this->seoUrl("motor dijual ".$data["Parent"]["name"]." ".$data["Category"]["name"]." (".$data["Product"]["thn_pembuatan"].") ".$data["ProvinceGroup"]["name"]).'.html</a>]]></DESCRIPTION>
