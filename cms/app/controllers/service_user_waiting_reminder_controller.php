<?php
class ServiceUserWaitingReminderController extends AppController
{
	...
	function Index()
	{
		...
		foreach($this->lists as $members)
		{
			...
			$send				=	$this->Action->EmailSend($this->mailName, $to, $search, $replace,$search_subject,$replace_subject,"User",$members['user_id']);
