...
<div style="width:95%; margin:auto; float:none;">
    <div class="box_panel" style="background-color:#dfeffc;">
        ...
        <div class="line1">
            <div  style="width: 500px; height: 300px; float:left; display:block; margin:5px;">&nbsp;</div>
        </div>
        <div style="margin:5px auto; float:none; width:170px;">
        	<div class="line1" style="margin-bottom:10px;">
                <div class="bungkus_cari"  style="width:60px;">
                    <input name="" type="button" class="button" value="Ok" style="width:60px;" onclick="GetLatLon()"/>
                </div>
                <div class="bungkus_cari"  style="width:60px;">
