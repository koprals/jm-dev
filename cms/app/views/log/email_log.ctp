...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>EmailLog/ListItem/<?php echo $user_id?>",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
	...
	//WATERMARK
	$("#SearchId").watermark({watermarkText:'Masukkan id activity',watermarkCssClass:'all_search_watermark'});
	$("#SearchFrom").watermark({watermarkText:'jualanmotor776@gmail.com',watermarkCssClass:'all_search_watermark'});
	$("#SearchTo").watermark({watermarkText:'<?php echo $email?>',watermarkCssClass:'all_search_watermark'});
	$("#SearchSubject").watermark({watermarkText:'Register',watermarkCssClass:'all_search_watermark'});
});
...
function SearchAdvance()
{
	...
	$("#SearchAdvance").ajaxSubmit({
		url:'<?php echo $settings['cms_url']?>EmailLog/ListItem/<?php echo $user_id?>',
		type:'POST',
		dataType: "html",
		clearForm:false,
    ...
    <div class="content">
        ...
        <div class="line1" style="margin-bottom:20px;">
            ...
            <div class="table3" style="width:99.8%; border:1px solid #D3C8AA; float:left; display:block; min-height:20px">
				<?php echo $form->create("Search",array("onsubmit"=>"return SearchItem()","id"=>"SearchIndexForm"))?>
                ...
                <div class="line1" style="margin:10px; display:none;" id="advanceddiv_1">
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        ...
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Tgl Kirim</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                        ...
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Type</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                 <?php echo $form->select("email_setting_id",$email_setting_id,false,array("style"=>"width:87%;float:left","class"=>"text8","label"=>"false","escape"=>false,"empty"=>'Action'));?>
                            </div>
                        </div>
        			</div>
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        ...
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">To</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                <?php echo $form->input("to",array("class"=>"all_search","div"=>false,"label"=>false,"type"=>"text"))?>
                            </div>
                        </div>
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Subject</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                <?php echo $form->input("subject",array("class"=>"all_search","div"=>false,"label"=>false,"type"=>"text"))?>
                            </div>
                        </div>
                    </div>
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                   		<div class="line1">
                            ...
                            <div class="left" style="width:68%;border:0px solid black;">
                            	<span class="text8">
                            		<?php echo $form->radio("status",array(1=>"Send",0=>"Not Send"),array("div"=>false,"label"=>true,"legend"=>false))?>
                            	</span>
                            </div>
                        </div>
                    </div>
