...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>UserLogs/ListItem/<?php echo $data['User']['id']?>",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
	...
	$("#SearchPointFrom").watermark({watermarkText:'100',watermarkCssClass:'all_search_watermark'});
	$("#SearchPointTo").watermark({watermarkText:'1000',watermarkCssClass:'all_search_watermark'});
