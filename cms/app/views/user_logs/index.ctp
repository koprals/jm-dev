...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>UserLogs/ListItem/<?php echo $user_id?>",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
...
<?php echo $this->requestAction('/Template/UserLeftMenu/'.$user_id."/activity",array('return'))?>
