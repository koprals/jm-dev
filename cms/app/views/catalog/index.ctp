<?php echo $html->css("jquery.ui.core")?>
<?php echo $html->css("jquery.ui.datepicker")?>
<?php echo $html->css("jquery.ui.theme")?>
<?php echo $javascript->link("jquery.ui.core")?>
<?php echo $javascript->link("jquery.ui.widget")?>
<?php echo $javascript->link("jquery.ui.datepicker.js")?>
...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>Catalog/ListItem",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
});
...
Ext.onReady(function(){
	...
	var getnodesUrl = '<?php echo $settings['cms_url'].'Catalog/getnodes' ?>';
	var reorderUrl = '<?php echo $settings['cms_url'].'Catalog/reorder/' ?>';
	var reparentUrl = '<?php echo $settings['cms_url'].'Catalog/reparent/' ?>';
	...
	tree.on('click', function(tree, node, event){
		...
		$("#list_item").load("<?php echo $settings['cms_url']?>Catalog/ListItem",{'data[Search][parent_id]':tree.id},function(){
			$(this).css("opacity","1");
			$("#loading_gede").hide();
		});
	});
