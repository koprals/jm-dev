...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>Users/ListItem/-2",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
...
function SearchAdvance()
{
	...
	$("#SearchAdvance").ajaxSubmit({
		url:'<?php echo $settings['cms_url']?>Users/ListItem/-2',
		type:'POST',
		dataType: "html",
		clearForm:false,
...
function CheckSuspend(ID)
{
	...
	$.prettyPhoto.open('<?php echo $settings['cms_url']?>Users/MessageSuspend/'+ID+'?iframe=true&width=490&height=420');
}
