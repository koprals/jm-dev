...
<?php
$order		=	array_keys($this->params['paging']['Invitation']['options']['order']);
$direction	=	$this->params['paging']['Invitation']['options']['order'];
...
<div id="output"></div>
<div class="line3">
    <a href="<?php echo $settings['cms_url'] ?>Invite/Add/" class="nav_6" style="float:right;"><img src="<?php echo $this->webroot?>img/icn_add.gif" border="0" style="float:left; margin-right:3px;" />Add User</a>
</div>
<div class="line1">
    <div class="left" style="width:60%;margin-top:8px;">
        <div class="text7" style="width:100%; float:left">
            ...
            <?php if($paginator->hasPrev()):?>
                <a href="<?php echo $settings['cms_url']?>Invite/ListItem/<?php echo $liststatus?>/page:<?php echo ($page-1)?>/limit:<?php echo $viewpage.$ordered?>" class="nav_table_left" onclick="return onClickPage(this,'#list_item')"></a>
            ...
            <?php if($paginator->hasNext()):?>
                <a href="<?php echo $settings['cms_url']?>Invite/ListItem/<?php echo $liststatus?>/page:<?php echo ($page+1)?>/limit:<?php echo $viewpage.$ordered?>" class="nav_table_right" onclick="return onClickPage(this,'#list_item')"></a>
            <?php endif;?>
            <span style="float:left;"><?php echo $paginator->counter(array('format' => 'of %pages% pages'));?> | View </span>
            
            <?PHP echo $form->select("view",array(1=>1,5=>5,10=>10,20=>20,100=>100,200=>200,1000=>1000),$viewpage,array("class"=>"text7","style"=>"width:auto; height:22px; float:left; margin:-5px 3px 0 3px; border:1px solid #c8c8c8; cursor:pointer;","onchange"=>"onClickPage('".$settings['cms_url']."Invite/ListItem/limit:'+this.value+'".$ordered."','#list_item')","empty"=>false))?>
...
<div class="line1">
    <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-color:#dadfe0; border-collapse:collapse;" onmouseout="OnMouseOutTable()" id="table" class="table_off">
        <tr class="table2" height="30">
            <td class="table_text1" style="border:1px solid #D3C8AA;width:50px;"><?php echo $paginator->sort('ID', 'Invitation.id',array('class'=>'table_text1','escape'=>false,'current'=>'current_sort'));?></td>
            
            <td class="table_text1" style="border:1px solid #D3C8AA;width:120px;"><?php echo $paginator->sort('Username', 'Invitation.username',array('class'=>'table_text1','escape'=>false,'current'=>'current_sort'));?></td>
            
            <td class="table_text1" style="border:1px solid #D3C8AA;width:120px;"><?php echo $paginator->sort('Email', 'Invitation.email',array('class'=>'table_text1','escape'=>false,'current'=>'current_sort'));?></td>
            
            <td class="table_text1" style="border:1px solid #D3C8AA;width:120px;"><?php echo $paginator->sort('Password', 'Invitation.password',array('class'=>'table_text1','escape'=>false,'current'=>'current_sort'));?></td>
            
            <td class="table_text1" style="border:1px solid #D3C8AA;width:120px;"><?php echo $paginator->sort('Telah Login', 'Invitation.comming',array('class'=>'table_text1','escape'=>false,'current'=>'current_sort'));?></td>
            
            <td class="table_text1" style="border:1px solid #D3C8AA;width:120px;" ><?php echo $paginator->sort('Tgl Invite', 'Invitation.create',array('class'=>'table_text1','escape'=>false,'current'=>'current_sort'));?></td>
            <td class="table_text1" style="border:1px solid #D3C8AA;width:120px;" ><?php echo $paginator->sort('Tgl Login', 'Invitation.comming_date',array('class'=>'table_text1','escape'=>false,'current'=>'current_sort'));?></td>
        ...
        <tr bgcolor="<?php echo $back?>">
            ...
            <td class="table_text2" style="border:1px solid #D3C8AA;"><?php echo $data['Invitation']['id']?></td>
            <td class="table_text3" style="border:1px solid #D3C8AA;"><?php echo $data['Invitation']['username']?></td>
            <td class="table_text3" style="border:1px solid #D3C8AA;"><?php echo chunk_split($data['Invitation']['email'],15,"<br />")?></td>
            
            <td class="table_text3" style="border:1px solid #D3C8AA;"><?php echo $general->my_decrypt($data['Invitation']['password'])?></td>
            
            <td class="table_text2" style="border:1px solid #D3C8AA;">
				<?php 
					$response	=	($data['Invitation']['comming']=="0") ? "Belum" : "Sudah";
					echo $response;
				?>
            </td>
            <td class="table_text3" style="border:1px solid #D3C8AA;" ><?php echo date("d-m-Y",strtotime($data['Invitation']['created']))?></td>
            
            <td class="table_text3" style="border:1px solid #D3C8AA;" >
			<?php 
				
				$comming_date	=	($data['Invitation']['comming_date'] == "0000-00-00 00:00:00") ? "-" : date("d-m-Y",strtotime($data['Invitation']['comming_date']));
				echo $comming_date;
			?>
            </td>
             <td class="table_text3" style="border:1px solid #D3C8AA;" >
             	<div class="line2">
                    <a href="<?php echo $settings['cms_url']?>Invite/Add/<?php echo $data['Invitation']['id']?>" class="nav_6">edit</a>
                </div>
             </td>
        </tr>
        <?php endforeach;?>
