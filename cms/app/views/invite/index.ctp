...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>Invite/ListItem",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
...
function SearchAdvance()
{
	...
	$("#SearchAdvance").ajaxSubmit({
		url:'<?php echo $settings['cms_url']?>Invite/ListItem',
		type:'POST',
		dataType: "html",
		clearForm:false,
                ...
                <div class="line1" style="margin:10px; display:none;" id="advanceddiv_1">
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        <div class="line1" style="margin-top:10px;">
                            ...
                            <div class="left" style="width:68%;border:0px solid black;">
                                <?php echo $form->input("name",array("class"=>"all_search","div"=>false,"label"=>false,"type"=>"text"))?>
                            </div>
                        </div>
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Username</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                <?php echo $form->input("username",array("class"=>"all_search","div"=>false,"label"=>false,"type"=>"text"))?>
                            </div>
                        </div>
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                    ...
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                    	<div class="line1" style="margin-top:15px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Password</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                <div class="left" style="width:68%;border:0px solid black;">
									<?php echo $form->input("password",array("class"=>"all_search","div"=>false,"label"=>false,"type"=>"text"))?>
                                </div>
                            </div>
                        </div>
                        <div class="line1" style="margin-top:15px;">
                        ...
                        <div class="line1" style="margin-top:15px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Sudah Login</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                <div class="text8" style="margin-top:-2px;">
                                    <?php echo $form->radio("comming",array("0"=>"Belum","1"=>"Sudah"),array("div"=>false,"label"=>true,"legend"=>false))?>
                                </div>
                            </div>
                        </div>
                    </div>
