...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>ProductLogDetail/ListItem/<?php echo $product_id?>",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
...
{
	$.getJSON('<?PHP echo $settings['cms_url']?>ProductLogDetail/GetFullText/'+ID,function(data){
		$('#span_'+ID).html(data+'\n<input type="button" value="close" onclick="CloseText(\''+ID+'\')">');	
	});
}
function CloseText(ID)
{
	$.getJSON('<?PHP echo $settings['cms_url']?>ProductLogDetail/GetTruncateText/'+ID,function(data){
...
{
	$.getJSON('<?PHP echo $settings['cms_url']?>ProductLogDetail/GetFullText2/'+ID,function(data){
		$('#span2_'+ID).html(data+'\n<input type="button" value="close" onclick="CloseText2(\''+ID+'\')">');	
	});
}
function CloseText2(ID)
{
	$.getJSON('<?PHP echo $settings['cms_url']?>ProductLogDetail/GetTruncateText2/'+ID,function(data){
		$('#span2_'+ID).html(data+'\n<input type="button" value="open" onclick="OpenText2(\''+ID+'\')">');	
	});	
}
...
function SearchAdvance()
{
	...
	$("#SearchAdvance").ajaxSubmit({
		url:'<?php echo $settings['cms_url']?>ProductLogDetail/ListItem/<?php echo $product_id?>',
		type:'POST',
		dataType: "html",
		clearForm:false,
...
function SearchItem()
{
	...
	$("#SearchIndexForm").ajaxSubmit({
		url:'<?php echo $settings['cms_url']?>Product/ListItem',
		type:'POST',
		dataType: "html",
		clearForm:false,
		beforeSend:function()
...
function CheckDelete(ID)
{
	...
	counter();
	ChangeDataConfirmation(ID,'didelete','menghapus','delete');
}
            ...
            <div class="table3" style="width:99.8%; border:1px solid #D3C8AA; float:left; display:block; min-height:20px">
                ...
                <div class="line1" style="margin:10px; display:none;" id="advanceddiv_1">
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        ...
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Tgl Edit</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                    ...
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        ...
                        <div class="line1" style="margin-top:10px;">
                            ...
                            <div class="left" style="width:68%;border:0px solid black;">
                                 <?php echo $form->select("status",$product_statuses,false,array("style"=>"width:100%;float:left","class"=>"text8","label"=>"false","escape"=>false,"empty"=>'Status'));?>
                            </div>
                        </div>
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                    ...
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        ...
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Modified By</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                <span class="text8">
                                    <?php echo $form->radio("modified_by",array("Owner"=>"Owner","Admin"=>"Admin"),array("div"=>false,"label"=>true,"legend"=>false))?>
                                </span>
                            </div>
                        </div>
                    </div>
