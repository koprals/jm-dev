...
<div class="line1" style="margin-top:30px;">
  <input type="button" class="button" value="Edit" style="margin-bottom:10px;" onclick="location.href='<?php echo $settings['cms_url']?>Product/Edit/<?php echo $product_id?>'"/>	
  <div class="table1" id="table_detail">
        <div class="line2" style="float:left; width:180px; padding-left:10px; font-size:12px; border:0px solid black;">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-color:#dadfe0; border-collapse:collapse;">
                    ...
                    <div class="line3" style="border:0px solid black; width:500px;" id="photo">
                        ...
                        <div class="left" style="margin-right:10px; width:150px;border:0px solid black; height:150px;">
                            <div class="image_box7" style="margin-left:0px; float: left;width:128px; height:128px;">
                                <a href="javascript:void(0)" onclick="$.prettyPhoto.open('<?php echo $settings['showimages_url']."?code=".$img['ProductImageLog']['id']."&prefix=_zoom&content=ProductImageLog&w=500&h=500&nopict=noimages"?>');" rel="zoom" path='img-zoom-<?php echo $img['ProductImageLog']['id']?>'>
                                    <img src="<?php echo $settings['showimages_url']."?code=".$img['ProductImageLog']['id']."&prefix=_prevthumb&content=ProductImageLog&w=128&h=128&nopict=noimages"?>" border="0"/>
                                </a>
                            </div>
                        </div>
                        <?php endforeach;?>
        ...
        <tr bgcolor="#ffffff" height="25">
            <td class="table_text2" style="border:1px solid #D3C8AA; text-align:center; width:50%; font-weight:bold" colspan="2">
            	<input type="button" class="button" value="Edit" style="margin-bottom:10px; margin-top:10px;" onclick="location.href='<?php echo $settings['cms_url']?>Product/Edit/<?php echo $product_id?>'"/>
            </td>
    	</tr>
    </table>
</div>