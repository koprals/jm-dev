...
$(document).ready(function(){
	...
	$("#list_item").load("<?php echo $settings['cms_url']?>Transaction/ListTransaction",function(){
		$(this).css("opacity","1");
		$("#loading_gede").hide();
	});
...
function SearchAdvance()
{
	...
	$("#SearchAdvance").ajaxSubmit({
		url:'<?php echo $settings['cms_url']?>Transaction/ListTransaction',
		type:'POST',
		dataType: "html",
		clearForm:false,
                ...
                <div class="line1" style="margin:10px; display:none;" id="advanceddiv_1">
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        <div class="line1" >
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Invoice.ID</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                <?php echo $form->input("invoice_id",array("class"=>"all_search","div"=>false,"label"=>false,"type"=>"text"))?>
                            </div>
                        </div>
                        ...
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Tgl Pembelian</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                    ...
                    <div class="left" style="width:31%;border:0px solid black; margin-right:10px">
                        <div class="line1" style="margin-top:10px;">
                            ...
                            <div class="left" style="width:68%;border:0px solid black;">
                                 <?php echo $form->select("status",$status,false,array("style"=>"width:100%;float:left","class"=>"text8","label"=>"false","escape"=>false,"empty"=>'Status'));?>
                            </div>
                        </div>
                        <div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Voucher</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                 <?php echo $form->select("voucher_id",$voucher_id,false,array("style"=>"width:100%;float:left","class"=>"text8","label"=>"false","escape"=>false,"empty"=>'Voucher'));?>
                            </div>
                        </div>
						<div class="line1" style="margin-top:10px;">
                            <div class="left" style="width:30%;border:0px solid black; margin-right:3px">
                               <span class="text9">Payment Method</span> 
                            </div>
                            <div class="left" style="width:68%;border:0px solid black;">
                                 <?php echo $form->select("payment_method_id",$payment_method_id,false,array("style"=>"width:100%;float:left","class"=>"text8","label"=>"false","escape"=>false,"empty"=>'Payment Method'));?>
                            </div>
                        </div>
                    </div>
                    <div class="line1" style="margin-top:10px;">
