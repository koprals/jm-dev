<?php
class ServiceAdProductWaitingShell extends Shell
{
	var $name 			=	'ServiceAdProductWaiting';
	var $uses 			=	array('Service');
	var $serviceName	=	"ad_product_waiting_approval";
	var $user_status	=	0;
	var $lists			=	array();
	var $mailName		=	"cron_product_waiting_approval";
	var $setings;
	var $emailID;
	...
	function Main()
	{
		...
		if($link)
		{
			...
			$send				=	$Action->EmailSend($this->mailName, $admin_mail, $search, $replace);
		}
