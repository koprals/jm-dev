...
{
	 var $ControllerName	= "Portfolios";
	 var $ModelName 			= "Portfolio";
	 ...
	 function beforeFilter()
	 {
			 ...
			 $find         = $this->MyAco->find("first", array(
					 "conditions" => array(
							 "LOWER(MyAco.alias)" => strtolower("Portfolio")
					 )
			 ));
	 ...
	 function ListItem()
	 {
			 ...
			 $this->{$this->ModelName}->BindCategory(false);
			 $this->{$this->ModelName}->BindSubcategory(false);
			 $this->{$this->ModelName}->BindClient(false);
