<?php
class PortfolioSubcategoriesController extends AppController
{
	 var $ControllerName	= "PortfolioSubcategories";
	 var $ModelName 			= "PortfolioSubcategory";
	 var $helpers 				=	array("Text","General");
	 var $uses 						=	"PortfolioSubcategory";
	 ...
	 function beforeFilter()
	 {
			 ...
			 $find         = $this->MyAco->find("first", array(
					 "conditions" => array(
							 "LOWER(MyAco.alias)" => strtolower("PortfolioSubcategories")
					 )
			 ));
	 ...
	 function Index($page = 1, $viewpage = 50)
	 {
			 ...
			 $portfolio_category_id_list		=		$this->PortfolioCategory->find("list",array(
									 													"conditions"	=>	array(
