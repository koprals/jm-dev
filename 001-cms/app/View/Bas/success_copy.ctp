...
<div class="titleArea">
    <div class="wrapper">
        <div class="pageTitle">
            <h5>Success Copy <?php echo $before[$ModelName]['name']?> to <?php echo $after[$ModelName]['name']?></h5>
...
<div class="wrapper">
	<div class="nNote nSuccess">
		<p><strong>SUCCESS: </strong>Success copy <?php echo  $before[$ModelName]['name']?> to <?php echo  $after[$ModelName]['name']?></p>
	</div>
	<div class="widget">
		<div class="body textC">
			<a href="<?php echo $settings["cms_url"].$ControllerName?>/Edit/<?php echo $afterId?>/<?php echo $page?>/<?php echo $viewpage?>" title="Back to Edit" class="button redB" style="margin: 5px;"><span>Edit this BA</span></a>
