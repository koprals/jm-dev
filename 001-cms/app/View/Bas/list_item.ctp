...
<div class="widget">
	<div class="title">
		...
		<h6>
			BA - Page <?php echo $this->Paginator->counter(); ?>
		</h6>
	</div>
	<div class="title">
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td style="width:10%;">
					<?php echo $this->Paginator->sort("$ModelName.code",'BA Code');?>
				</td>
				<td style="width:15%;">
					<?php echo $this->Paginator->sort("$ModelName.name",'Name');?>
				</td>
				<td style="width:15%;">
					<?php echo $this->Paginator->sort("$ModelName.email", 'Email');?>
				</td>
				<!--
				<td style="width:10%;">
					<?php /*echo $this->Paginator->sort("City.name", 'City'); */?>
				</td>-->
				<td style="width:10%;">
					<?php echo $this->Paginator->sort("$ModelName.phone", 'Phone');?>
				</td>
				<td style="width:10%;">
		...
		<tbody>
			...
			<?php foreach($data as $data): ?>
				...
				<tr <?php echo $class?>>
					...
					<td>
						<a rel="lightbox" title="<?php echo $data[$ModelName]['name'] ?>" href="<?php echo $data["Image"]["host"].$data["Image"]["url"]?>?time=<?php echo time()?>" style="border:0px;">
					...
					<td><?php echo $this->General->IsEmptyVal($data[$ModelName]['phone'])?></td>
					<td style="text-align:center;"><?php echo $data[$ModelName]['SStatus'] ?></td>
					...
					<td style="text-align:center;">
						<?php if($access[$aco_id]["_create"] == 1):?>
							<!--a href="<?php echo $settings['cms_url'].$ControllerName?>/CopyRow/<?php echo $data[$ModelName]["id"]?>/<?php echo $page?>/<?php echo $viewpage?>" class="tipS smallButton blackB" title="Copy">
								<img src="<?php echo $this->webroot?>img/icons/topnav/register.png" alt="Delete"/>
							</a-->
						<?php endif;?>
