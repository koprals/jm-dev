...
$(document).ready(function(){
	...
	$("#contents_area").load("<?php echo $settings['cms_url'] . $ControllerName?>/NotSoldProductListItem/page:<?php echo $page?>/limit:<?php echo $viewpage?>/?time=<?php echo time()?>",function(){
...
function SearchAdvance()
{
	$("#SearchAdvance").ajaxSubmit({
		url:"<?php echo $settings['cms_url'].$ControllerName ?>/NotSoldProductListItem",
		type:'POST',
		dataType: "html",
		clearForm:false,
		beforeSend:function()
	...
	<div class="span6">
		<div class="bc">
	        <ul id="breadcrumbs" class="breadcrumbs">
	             <li>
	                  <a href="javascript:void(0)">Not Sold</a>
	             </li>
	             <li class="current">
