...
<script>
	...
	$(document).ready(function() {
			...
			<?php foreach($this->request->data[$ModelName]["photo"] as $k => $photo):?>
				AddImage('<?php echo $errorImg[$k]?>','<?php echo $photo["url"]?>','<?php echo $photo["path"]?>','<?php echo $photo["id"]?>');
			<?php endforeach;?>
			<?php endif;?>
			/***** IMAGE *****/
	...
	function AddImage(errorImg,defaultImage,path,id)
	{
		if(counterImage<10)
		{
			var b	=	'\
			<div class="formRow" id="uploadForm'+totalImage+'">\
				...
				<div class="formRight">\
					...
					<div style="float:left; display:block; margin-left:10px;width:260px;">\
						...
						<input type="hidden" value="'+totalImage+'" id="posImage'+totalImage+'" name="data[<?php echo $ModelName?>][pos_image][]">\
						<input type="hidden" value="'+path+'" id="pathImage'+totalImage+'" name="data[<?php echo $ModelName?>][path_image][]">\
						<input type="hidden" value="'+defaultImage+'" id="urlImage'+totalImage+'" name="data[<?php echo $ModelName?>][url_image][]">\
						<input type="hidden" value="'+id+'" id="idImage'+totalImage+'" name="data[<?php echo $ModelName?>][id_image][]">\
    ...
    <div class="wrapper">
	    <div class="pageTitle">
	        <h5>Edit <?php echo Inflector::humanize(Inflector::underscore($ModelName))?></h5>
					<span><?php echo $detail[$ModelName]["title"]?></span>
	    </div>
	    <div class="middleNav">
				<ul>
					<li class="mUser">
		...
		<div class="span12">
			...
			<div class="widget">
				<div class="title">
					...
					<h6>Edit <?php echo Inflector::humanize(Inflector::underscore($ModelName))?></h6>
				</div>
				<div id="tabMenu">
					<ul>
					...
					<?php echo $this->Form->create($ModelName, array('url' => array("controller"=>$ControllerName,"action"=>"Edit","?"=>"debug=0", $ID,$page,$viewpage),'class' => 'form',"type"=>"file","novalidate")); ?>
					<?php
					...
					<div id="tabs-2">
						...
						<a href="javascript:void(0);" title="Add Images" class="button blueB" style="color:white;" onclick="AddImage('','<?php echo $this->webroot?>img/default_content_horizontal.png','','')">
