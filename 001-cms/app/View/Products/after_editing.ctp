...
$(document).ready(function(){
	...
	$("#contents_area").load("<?php echo $settings['cms_url'] . $ControllerName?>/AfterEditingListItem/page:<?php echo $page?>/limit:<?php echo $viewpage?>/?time=<?php echo time()?>",function(){
...
function SearchAdvance()
{
	$("#SearchAdvance").ajaxSubmit({
		url:"<?php echo $settings['cms_url'].$ControllerName ?>/AfterEditingListItem",
		type:'POST',
		dataType: "html",
		clearForm:false,
		beforeSend:function()
...
<div class="titleArea">
    <div class="wrapper">
        <div class="pageTitle">
            <h5>After Editing Advertisement</h5>
            <span>List</span>
        </div>
    </div>
</div>
	...
	<div class="span6">
		<div class="bc">
	        <ul id="breadcrumbs" class="breadcrumbs">
	             <li>
	                  <a href="javascript:void(0)">After Editing Advertisement</a>
	             </li>
	             <li class="current">
