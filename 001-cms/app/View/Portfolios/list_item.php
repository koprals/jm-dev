...
<div class="widget">
	<div class="title">
		...
		<h6>
			Mandor - Page <?php echo $this->Paginator->counter(); ?>
		</h6>
	</div>
	<div class="title">
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td style="width:12.5%;">
					<?php echo $this->Paginator->sort("PortfolioCategory.name",'Category');?>
				</td>
				<td style="width:12.5%;">
					<?php echo $this->Paginator->sort("PortfolioSubcategory.name",'Subcategory');?>
				</td>
				<td style="width:15%;">
					<?php echo $this->Paginator->sort("Client.name", 'Client');?>
				</td>
				<td style="width:10%;">
		...
		<tbody>
			...
			<?php foreach($data as $data): ?>
				...
				<tr <?php echo $class?>>
					...
					<td>
						<a rel="lightbox" title="<?php echo $data[$ModelName]['title'] ?>" href="<?php echo $data["PortfolioImage"]["Image"]["host"].$data["PortfolioImage"]["Image"]["url"]?>?time=<?php echo time()?>" style="border:0px;">
							<img src="<?php echo $data["PortfolioImage"]["Image"]["host"].$data["PortfolioImage"]["Image"]["url"]?>?time=<?php echo time()?>" width="60"/>
						</a>
					</td>
					<td><?php echo $data[$ModelName]['title'] ?></td>
					<td><?php echo $data["PortfolioCategory"]['name'] ?></td>
					<td><?php echo $data["PortfolioSubcategory"]['name'] ?></td>
					...
					<td style="text-align:center;">
						<?php if($access[$aco_id]["_update"] == 1):?>
							...
							<?php if($data[$ModelName]['status']=="1"):?>
								<a href="javascript:void(0);" onclick="ChangeStatus('Do you realy want deactivate this item ?','<?php echo $data[$ModelName]['id']?>','0')" class="tipS smallButton greenB" title="Deactivate">
