...
<div class="titleArea">
    <div class="wrapper">
        <div class="pageTitle">
            <h5>Success Edit <?php echo ucfirst($ModelName)?></h5>
...
<div class="wrapper">
	<div class="nNote nSuccess">
		<p><strong>SUCCESS: </strong>Success edit <?php echo strtolower($ModelName)?></p>
	</div>
	<div class="widget">
		<div class="body textC">
			<a href="<?php echo $settings["cms_url"].$ControllerName?>/Edit/<?php echo $ID?>/<?php echo $page?>/<?php echo $viewpage?>" title="Back to Edit" class="button redB" style="margin: 5px;"><span>Edit this brand</span></a>
