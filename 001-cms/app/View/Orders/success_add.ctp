...
<div class="titleArea">
    <div class="wrapper">
        <div class="pageTitle">
            <h5>Success add new <?php echo $ModelName?></h5>
...
<div class="wrapper">
	<div class="nNote nSuccess">
		<p><strong>SUCCESS: </strong>Success add new <?php echo strtolower($ModelName)?></p>
	</div>
	<div class="widget">
		<div class="body textC">
			<a href="<?php echo $settings["cms_url"].$ControllerName?>/Edit/<?php echo $ID?>" title="Back to Edit" class="button redB" style="margin: 5px;"><span>Edit this brand</span></a>
