...
/** CUSTOM VALIDATION FOR SCF
**/

/**
 * Checks that a string contains alphabet and some funny character
 *
 * Returns true if string contains only alphabet and some funny character
 *
 ...
 */
	public static function scfName($check) {
		...
		//return self::_check($check, "/^[a-zA-Z\x28\x29 \/ ',.@-]{1,}$/");
		return self::_check($check, "/^[a-zA-Z ,.]{1,}$/");
	}
	//" ", ",", " ' ", ".", "/", "@", "-", "(", ")"
	//
	public static function scfNameForMacAddress($check) {
		...
		return self::_check($check, "/^[a-zA-Z0-9\x20\x2C\x27\x2E\/@\x28\x29\x2D]{1,}$/");
	}
	
	//scf ini gw tambain spasi \x20
	public static function scfCompanyName($check) {
		...
		return self::_check($check, "/^[a-zA-Z0-9\x20\x60\x27\x2E\/\x40\x22\x28\x29\x26\x5F\x2D]{1,}$/");
	}
	
	public static function scfPassword($check) {
		...
		return self::_check($check, "/^[a-zA-Z0-9\x21\x40\x23\x23\x24\x25\x26\x27\x2A\x2B\x2D\/=\x3F\x5E_\x60\x7B\x7D\x7C\x7E]{1,}$/");
	}

/**
 * Checks that a string contains must be 12 character numeric
 *
 * Returns true if string contains only must be 12 characters numeric
 *
 * $check can be passed as an array:
 * array('check' => 'valueToCheck');
 *
 ...
 * @return boolean Success
 */
	public static function mustbe12char($check) {
		...
		return self::_check($check, "/^[0-9]{12}$/i");
	}
	
/**
 * Checks that a string contains according to SCF Document Mobile Number 12 - 14 char
 *
 * Returns true if string contains accourding to SCF Document Mobile NUmber
 *
 * $check can be passed as an array:
 * array('check' => 'valueToCheck');
 *
 ...
 * @return boolean Success
 */
	public static function scfMobileNumber($check) {
		...
		return self::_check($check, '/^(010|011|012|013|014|015|016|017|018|019)[0-9]{7,11}$/');
	}
	
	public static function scfPhone($check) {
		...
		return self::_check($check, '/^[0-9]{6,17}$/');
	}
	
	
	public static function scfPhoneNumber($check) {
		...
		//return self::_check($check, '/^(\+|[1-9]){1}([0-9]+)$/');
		return self::_check($check, '/^(\+6)[0-9]{9,12}$/');
	}
