 ...
 */
	protected static $_currencies = array(
		...
		'IDR' => array(
			'wholeSymbol' => 'Rp ', 'wholePosition' => 'before', 'fractionSymbol' => false, 'fractionPosition' => 'after',
			'zero' => 0, 'places' => 0, 'thousands' => ',', 'decimals' => '.', 'negative' => '()', 'escape' => true,
			'fractionExponent' => 0
		)
	);
	...
	public static function toReadableSize($size) {
		switch (true) {
			...
			case round($size / 1024) < 1024:
				return __d('cake', '%s KB', self::precision($size / 1024, 2));
