...
<div class="line top10">
	<div class="body_all" style="border:0px solid black;">
    	<!-- Kiri -->
        <div class="kiri size20" style="border:0px solid black;">
        ...
        <!-- Tengah -->
        	<div class="kiri size78 left10" style="border:0px solid black;">
