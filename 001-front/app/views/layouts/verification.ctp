...
<meta name="msvalidate.01" content="7648DBCE28732DE9F9ECBB177F056212" />
...
<?php echo $this->requestAction("/Template/HeaderMenuVerification/{$profile['Profile']['fullname']}",array("return"))?>
<!-- Body -->
<div class="line top10">
	<div class="body_all">
        ...
        <div class="kiri size18 top-47"> 
            ...
            <!-- MEMBER OF THE MONTH -->
            <?php echo $this->element('member_of_the_month',array('cache' => array('time' => '1 hours')))?>
            <!-- MEMBER OF THE MONTH -->
            ...
            <!--  Testimonial -->
            <?php echo $this->element('testimonial',array('cache' => array('time' => '1 hours')))?>
            <!--  Testimonial -->
        </div>
        <!-- End Kiri -->
        <!-- Kanan -->
        <div class="kanan size18">
        	<!--  Banyak Dicari -->
            <?php echo $this->element('banyak_dicari',array('cache' => array('time' => '+7 day')))?>
            <!--  Banyak Dicari -->
