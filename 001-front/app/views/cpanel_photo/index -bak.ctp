            ...
            <div class="line1">
                <div class="left" style="width:120px; height:120px;border:0px solid black;">
                    <div class="left" style="width:120px;height:120px;">
                        ...
                        <img src="<?php echo $settings['showimages_url']?>?code=<?php echo $profile['User']['id']?>&prefix=_prevthumb&content=User&w=120&h=120" id="UserPhoto" style="border:1px solid #999999; padding:2px;"/>
