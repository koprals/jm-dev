...
<div class="line top10" style="border:0px solid black">
    ...
    <div class="product" <?php echo $style?> onmouseover="Over('#caption_<?php echo $product_id?>','#view_detail_<?php echo $product_id?>');" onmouseout="Out('#caption_<?php echo $product_id?>','#view_detail_<?php echo $product_id?>')">
        <div class="gambar">
            <a href="<?php echo $settings['site_url']?>Iklan/Detail/<?php echo $product_id."/".$general->seoUrl("motor dijual ".$new["Parent"]["name"]." ".$new["Category"]["name"]." (".$new["Product"]["thn_pembuatan"].") ".$new["ProvinceGroup"]["name"]).".html"?>"><img src="<?php echo $settings['showimages_url']."/ProductImage_282_153_".$new['ProductImage']['id'].".jpg?code=".$new['ProductImage']['id']."&prefix=_282_153&content=ProductImage&w=282&h=153"?>" border="0" alt="<?php echo $new["Parent"]["name"]." ".$new["Category"]["name"]." (".$new["Product"]["thn_pembuatan"].") ".$new["ProvinceGroup"]["name"]?>"/></a>
        </div>
        <div style="position: absolute; top:12px; left:100px; display:none" id="view_detail_<?php echo $product_id?>">
        	<a href="<?php echo $settings['site_url']?>Iklan/Detail/<?php echo $product_id."/".$general->seoUrl("motor dijual ".$new["Parent"]["name"]." ".$new["Category"]["name"]." (".$new["Product"]["thn_pembuatan"].") ".$new["ProvinceGroup"]["name"]).".html"?>"><img src="<?php echo $this->webroot?>img/view_detail.png"  border="0" alt="view detail"></a>
        </div>
        <div class="line" style="height:20px;">&nbsp;</div>
        <div class="descthumb">
        	<div class="line" style="position:relative;">
               <div style="border:0px solid black;position:absolute;bottom:-1px;width:100%;background-color:white;display:block;height:22px; overflow:hidden; color:#000;" id="caption_<?php echo $product_id?>">
                    ...
                    <div class="kanan size40 top3">
                        ...
                        <div class="line top5">
                            <div class="kiri right5 top5"><a href="<?php echo $settings['site_url']?>Iklan/Detail/<?php echo $new['Product']['id']."/".$general->seoUrl("motor dijual ".$new["Parent"]["name"]." ".$new["Category"]["name"]." (".$new["Product"]["thn_pembuatan"].") ".$new["ProvinceGroup"]["name"]).".html"?>" title="Klik disini untuk memberikan komentar."><img src="<?php echo $this->webroot?>img/comment_ico.gif" border="0" alt="icon comment"/></a></div>
                            <div class="kiri style1 text11 grey2 right7 top5"><?php echo $comment?></div>
                            <div class="kiri top5"><a href="javascript:void(0)"><img src="<?php echo $this->webroot?>img/album_views16.gif" border="0" alt="icon view"/></a></div>
                            <div class="kiri style1 text11 grey2 right5 top5"> <?php echo $view?></div>
                            <div class="kanan">
                            	<a href="javascript:void(0)" title="<?php echo $new['Product']['contact_name']?>"><img src="<?php echo $ico?>" style="border:none" alt="<?php echo $new['Product']['contact_name']?>"/></a>
                            </div>
                            <?php if(!empty($ym)):?>
    ...
    <div class="kanan" style="border:1px solid balck;"><a href="<?php echo $settings['site_url']?>DaftarMotor/all_categories/all_cities/all-categories_semua-kota.html" class=" style1 red text12 bold normal">Selengkapnya <img src="<?php echo $this->webroot?>img/admin_arrowright.gif" style="vertical-align:middle; border:none; margin-left:5px;" alt="selengkapnya"/></a></div>
</div>