...
<div class="line" style="margin-top:10px;">
    <div class="menu_kanan" style="border:none;">
        <div style="font-size:12px;background:none; padding:10px 0 0 10px">
            <span class="kiri"><a href="<?php echo $settings['site_url']?>MotorKlasik/all_categories/all_cities/motor_klasik_dijual.html" class="style1 normal" style="color:#ffffff;text-shadow:0px 1px 3px #272727,0px 1px 3px #272727;">MOTOR KLASIK</a></span>
        </div>
    </div>
