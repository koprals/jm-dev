<?php echo $this->requestAction("/Template/DaftarSubcategory/{$current_category_id}/{$current_city}/MotorMurah",array("return"))?>
<?php echo $this->requestAction("/Template/DaftarKota/{$current_category_id}/{$current_city}/MotorMurah",array("return"))?>
...
function GotoPage(value)
{
	...
	location.href	=	'<?php echo $settings['site_url']."MotorMurah/".implode("/",$this->params['pass'])?>/page:'+val;
}
...
<div class="line top40" style="border:0px solid black;">
	...
	<?php
		...
		if(!empty($data["AdsRequest"]))
		{
			...
			{
				if($AdsRequest["ads_type_id"]=="3")
				{
					$content_hot	=	'<div class="content_premium"></div>';
				}
				elseif($AdsRequest["ads_type_id"]=="2")
				{
    ...
    <div class="<?php echo $product_hot?>" <?php echo $style;?>>
		<?php echo $content_hot;?>
            ...
            <div class="kiri" style="border:0px solid black;width:160px;">
                ...
                <div class="line top7">
                    ...
                    <div class="kanan style1 text11 grey">
                    	<div class="kiri right7 top3"><a href="javascript:void(0)" title="Dilihat sebanyak <?php echo $view?> orang"><img src="<?php echo $this->webroot?>img/album_views16.gif" style="border:none; vertical-align:middle;" alt="dilihat"/></a><?php echo $view?></div>
	...
	<div class="product size100" style="width:100%;">
    	<div class="gambar" style="height:105px;border:0px solid black; margin-top:5px;">
        	<div class="kiri left10" style="width:auto; border:0px solid black;">
                <img src="<?php echo $settings['site_url']?>img/warning_big.png" alt="warning big"/>
            </div>
            <div class="kiri size65 left20 style1 black1 text12 top10 bold">
                Maaf kami tidak menemukan motor murah <?php echo $error_msg?>.
            </div>
		</div>
    </div>
</div>
...
<div class="line top20" style="border:0px solid black;">
	<div class="line top20">
        <div class="kiri style1 black bold text14 bottom10 size50" style="border:0px solid black"><?php echo $category_others[0]['Parent']['name']?> murah dengan tipe lain di <?php echo $province_name?></div>
...
<div class="line top20" style="border:0px solid black;">
	<div class="line top20">
        <div class="kiri style1 black bold text14 bottom10 size50" style="border:0px solid black"><?php echo $category_name?> murah di kota lain.</div>
        <div class="kanan size45 style1 grey2 text11 bottom5" style="text-align:right;border:0px solid black">
            <span class="right10"><img src="<?php echo $this->webroot?>img/dealer_ico.gif" style="vertical-align:middle" class="right5" alt="icon dealer"/> Dealer</span>
            <span class="right10"><img src="<?php echo $this->webroot?>img/seller_ico.gif" style="vertical-align:middle" class="right5" alt="icon perorangan"/> Perorangan</span>
            <span class="right10"><img src="<?php echo $this->webroot?>img/album_views16.gif" style="vertical-align:middle" alt="icon view"/> Dilihat</span>
